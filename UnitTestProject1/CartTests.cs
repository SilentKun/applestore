...
namespace AppleStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Gadget game1 = new Gadget { GadgetId = 1, Name = "Гаджет1" };
            Gadget game2 = new Gadget { GadgetId = 2, Name = "Гаджет2" };
            ...
            Assert.AreEqual(results[0].Gadget, game1);
            Assert.AreEqual(results[1].Gadget, game2);
        }
        [TestMethod]
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            // Организация - создание нескольких тестовых игр
            Gadget gadget1 = new Gadget { GadgetId = 1, Name = "Гаджет1" };
            Gadget gadget2 = new Gadget { GadgetId = 2, Name = "Гаджет2" };

            // Организация - создание корзины
            Cart cart = new Cart();

            // Действие
            cart.AddItem(gadget1, 1);
            cart.AddItem(gadget2, 1);
            cart.AddItem(gadget1, 5);
            List<CartLine> results = cart.Lines.OrderBy(c => c.Gadget.GadgetId).ToList();
        ...
        public void Can_Remove_Line()
        {
            ...
            Gadget gadget1 = new Gadget { GadgetId = 1, Name = "Гаджет1" };
            Gadget gadget2 = new Gadget { GadgetId = 2, Name = "Гаджет2" };
            Gadget gadget3 = new Gadget { GadgetId = 3, Name = "Гаджет3" };
            ...
            cart.AddItem(gadget1, 1);
            cart.AddItem(gadget2, 4);
            cart.AddItem(gadget3, 2);
            cart.AddItem(gadget2, 1);

            // Действие
            cart.RemoveLine(gadget2);

            // Утверждение
            Assert.AreEqual(cart.Lines.Where(c => c.Gadget == gadget2).Count(), 0);
        ...
        {
            // Организация - создание нескольких тестовых игр
            Gadget gadget1 = new Gadget { GadgetId = 1, Name = "Гаджет1", Price = 100 };
            Gadget gadget2 = new Gadget { GadgetId = 2, Name = "Гаджет2", Price = 55 };
        ...
        public void Can_Add_To_Cart()
        {
            ...
            Assert.AreEqual(cart.Lines.ToList()[0].Gadget.GadgetId, 1);
        }
